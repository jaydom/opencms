...
App.run(["$rootScope", "$state", "$stateParams",  '$window', '$templateCache', function ($rootScope, $state, $stateParams, $window, $templateCache) {
  ...
  $rootScope.$on('user.login.success', function(handle, data){
        // 处理
        console.log(data)
    });
  // Scope Globals
...
function ($stateProvider, $locationProvider, $urlRouterProvider, helper) {
  ...
  $stateProvider
    .state('app', {
        ...
        controller: 'AppController',  templateUrl: helper.basepath('app.html'),
...
App.controller('DataTableController', ['$scope', '$resource', 'DTOptionsBuilder', 'DTColumnDefBuilder','$stateParams',
  function($scope, $resource, DTOptionsBuilder, DTColumnDefBuilder,$stateParams) {
  'use strict';
...
App.controller('LocalizationController', ["$rootScope", "tmhDynamicLocale", "$locale", function($rootScope, tmhDynamicLocale, $locale) {
  ...
  $rootScope.model = {selectedLocale: 'cn'};
